...
namespace CloudWeather.Report.BusinessLogic
{
    ...
    public class WeatherReportAggregator : IWeatherReportAggregator
    {
        ...
        public async Task<WeatherReport> BuildReport(string zip, int days)
        {
            ...
            var precipData = await FetchPrecipitaionData(httpClient, zip, days);
            ...
            var weeatherReport = new WeatherReport
            {
            ...
            _db.Add(weeatherReport); // tracks changes
            await _db.SaveChangesAsync(); 
            return weeatherReport;
        }
        ...
        private async Task<List<PrecipitationModel>> FetchPrecipitaionData(HttpClient httpClient, string zip, int days)
        {
